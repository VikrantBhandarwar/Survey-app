  ...
  return (
    <React.Fragment>
      <NetworkErrorBoundary fallbackComponent={ErrorMessage}>
        ...
        <Divider hidden />
        <Segment compact className="ui teal inverted segment">
          <Header>Participation rate: <Label data-testid="surveyRate">{ (survey.response_rate*100).toFixed(1) }%</Label> </Header>
